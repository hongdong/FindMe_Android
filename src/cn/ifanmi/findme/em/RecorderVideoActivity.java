...
implements OnClickListener, Callback, OnErrorListener, OnInfoListener{
...
//			mediarecorder.setVideoFrameRate(10);
		...
		case R.id.recorder_stop:
			...
			new AlertDialog.Builder(this).setMessage("是否发送？").setPositiveButton(R.string.confir, new DialogInterface.OnClickListener() {
